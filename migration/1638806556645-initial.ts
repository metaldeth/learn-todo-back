...
export class initial1638806556645 implements MigrationInterface {
    name = 'initial1638806556645'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "taskList" ("id" SERIAL NOT NULL, "isArchived" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "caption" character varying(255) NOT NULL, "connectTaskId" integer, "connectTaskListId" integer, CONSTRAINT "PK_27d740f0baf101d7f90ce404eca" PRIMARY KEY ("id"))`);
